...
static int secp256k1_gej_is_valid(const secp256k1_gej_t *a) {
    ...
    secp256k1_fe_mul_int(&z6, 7); // should fix this but going to leave as is for now to see how it breaks
...
static void secp256k1_ge_start(void) {
  ...
  // i'm just gonna blindly place prime 256v1 constants in here
  //      0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
...
//  not using endomorphism with prime256v1  .. ignore these for now
